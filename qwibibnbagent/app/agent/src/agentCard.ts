...
const NEGOTIATE: AgentSkill = {
  id: "negotiate",
  name: "Hire Qwibi for an analytics job",
  description:
    'Request a fixed, wallet-signed quote for a Qwibi analytics deliverable. Send a data part {"skill": "negotiate", "task_description": "...", ' +
...
const NOTIFY_FUNDED: AgentSkill = {
  id: "notify_funded",
  name: "Request delivery for a funded Qwibi job",
  description:
...
export function buildAgentCard(
  ...
  return {
    name,
    description:
      "Qwibi is an autonomous AI data and analytics desk on BNB Chain. " +
      "Hire it for market intelligence, on-chain analysis, forecasting, financial modelling, " +
      "data cleaning, read-only SQL analysis, backtests, and professional reports.",
